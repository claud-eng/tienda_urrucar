# Generated by Django 4.2.10 on 2024-11-01 20:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Usuario.cliente')),
                ('productos', models.ManyToManyField(through='Transaccion.DetalleOrden', to='Transaccion.producto')),
                ('servicios', models.ManyToManyField(through='Transaccion.DetalleOrden', to='Transaccion.servicio')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orden_venta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='detalleordenventa_set', to='Transaccion.ordendeventa')),
        ...
        migrations.AddField(
            ...
            name='orden_compra',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Transaccion.ordendecompra'),
        ),
        migrations.AddField(
            model_name='detalleorden',
            name='producto',
