...
from . import views_ventas_manuales  # Importa el módulo que maneja las ventas manuales.
from . import views_ventas_online  # Importa el módulo que maneja las ventas online.
...
urlpatterns = [
    ...
    path('agregar_venta_manual_producto', views_ventas_manuales.agregar_venta_manual_producto, name='agregar_venta_manual_producto'),  # Ruta para agregar venta manual de un producto
    path('agregar_venta_manual_servicio', views_ventas_manuales.agregar_venta_manual_servicio, name='agregar_venta_manual_servicio'),  # Ruta para agregar venta manual de un servicio
    path('api/buscar-productos/', views_ventas_manuales.buscar_productos, name='buscar_productos'), # Buscar el nombre y/o patente de un producto
    path('api/buscar-servicios/', views_ventas_manuales.buscar_servicios, name='buscar_servicios'), # Buscar el nombre de un servicio
    ...
    path('editar_venta_manual_producto/<int:venta_id>/', views_ventas_manuales.editar_venta_manual_producto, name='editar_venta_manual_producto'), # Editar una venta manual de un producto
    path('editar_venta_manual_servicio/<int:venta_id>/', views_ventas_manuales.editar_venta_manual_servicio, name='editar_venta_manual_servicio'), # Editar una venta manual de un servicio
    path('editar-venta-online/<int:venta_id>/', views_ventas_online.editar_venta_online, name='editar_venta_online'), # Editar una venta online
    ...
    path('listar_ventas_manuales', views_ventas_manuales.listar_ventas_manuales, name='listar_ventas_manuales'),  # Listar ventas manuales
    path('listar_ventas_online', views_ventas_online.listar_ventas_online, name='listar_ventas_online'),  # Listar ventas online
